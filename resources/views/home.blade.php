    ...
    <div class="border">
        ...
        <div class="container px-0 text-center">
            <div class="row gx-5 d-flex justify-content-start align-items-start">
                <div class="col">
                    <div class="p-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet,
                        distinctio?
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores,
                        tempora.
                    </div>
                </div>
            </div>
