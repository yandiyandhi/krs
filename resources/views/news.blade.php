            ...
            <div class="header-content">
                <div class="single-post-info">
                    ...
                    <div class="single-post-min-description">
                        <p class="text-white">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Unde, pariatur explicabo.
                            Reiciendis
                            ea modi reprehenderit rem dolorem cum praesentium, laboriosam excepturi veritatis
                            tempore
                            minus
                            architecto ad autem ab facilis. Ratione. Lorem ipsum dolor, sit amet consectetur
                            adipisicing elit. Et ullam excepturi impedit sint, velit nostrum! Exercitationem, veniam
                            esse maxime, placeat natus reprehenderit minima doloremque fuga reiciendis voluptas,
                            itaque ea assumenda.
                        </p>
                    </div>
        ...
        <div class="single-post-body">
            <div class="left-nav">
                <p class="text-content">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis eveniet qui commodi quam ab
                    distinctio rem odit dolor Hilmanquid. Illum voluptatum eligendi, dolorem assumenda, aperiam Hilmanas,
                    sequi laboriosam ipsum quis numquam cum magni sint eveniet aut ea deserunt voluptatibus ex
                    molestias maxime itaque tempora consequatur porro. Modi officiis at magnam ex placeat ullam rem.
                    Quas quibusdam voluptatem voluptas voluptates perferendis suscipit asperiores laudantium minus?
                    Sit quas beatae deleniti fugit non! Dicta omnis a modi, neque inventore veritatis consequuntur
                    tempora officiis explicabo perspiciatis. Vitae exercitationem ratione dolorem! Hic, repellendus
                    quaerat asperiores, nobis ducimus eaque harum ipsum sint iusto necessitatibus facere veniam.
                </p>
                <div class="gallery">
                    <img src="/image/06.jpg" alt="image" class="img gallery-img">
                    <img src="/image/07.jpg" alt="image" class="img gallery-img">
                    <img src="/image/05.jpg" alt="image" class="img gallery-img">
                </div>
                <p class="text-content">
